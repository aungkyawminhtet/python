...
def main_sector():
    ...
    try:
        ...
        print("Please only entet interger number!")
        main_sector()
...
#input data checking function
# def data_checking(option_data):
#     try:
#         data_one = int(option_data) 
#         print("interger :",data_one)       
#     except ValueError:
#         data_one = str(option_data)
#         print("String Input is Invalid in main option:",data_one)
